...
const SignupScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <Entypo  name={"user"} size={30} color={"black"} style={styles.icon}/>
  ...
  <AntDesign name={"google"} size={30} color={"black"} style={[styles.icon, styles.iconMargin]} />
  <AntDesign name={"linkedin-square"} size={30} color={"blue"} style={[styles.icon, styles.iconMargin]} />
